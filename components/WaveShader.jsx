...
import vertex from "../public/glsl/waveShader_vs.glsl";
import fragment from "../public/glsl/waveShader_fs.glsl";
import loadTexture from "../utils/loadTexture";

class WaveShader extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  onLoadCanvas = async (canvas) => {
    ...
    const texWaterImage = await loadTexture("./images/water.jpg");
    texWaterImage.wrapS = RepeatWrapping;
    texWaterImage.wrapT = RepeatWrapping;
    ...
    const material = new ShaderMaterial({
      ...
      uniforms: {
        ...
        texCloud: {
          value: await loadTexture("./images/texCloud.jpg"),
        },
        texWater: {
          value: texWaterImage,
        },
